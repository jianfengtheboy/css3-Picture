  ...
  .qq {
    ...
    .head {
      ...
      .lipShadow.right {
        top: 4px;
        left: 111px;
        @include transform(rotate(60deg) rotateY(180deg));
      }
    }
    ...
    .body {
      ...
      .scarfEndShadow {
        ...
        @include transform-origin(top, right);
        @include transform(skewX(4deg) scaleY(1.5) rotate(-60deg));
      }
    ...
    .footWrapper {
      ...
      .toe.right {
        top: 50px;
        left: 264px;
        @include transform(rotate(45deg) rotateY(180deg));
      }
