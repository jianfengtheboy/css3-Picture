 ...
 * @Date: 2021-04-30 17:06:53
 * @LastEditTime: 2021-04-30 17:38:07
 * @Description: 猫
-->
<template>
  <div class="cat">
...
.cat {
  ...
  .mao_head {
    ...
    background: #F6F7F2;
    position: relative;
    @include border-radius(50% 50% 35% 35%);
  ...
  .erduo > div:first-child {
    ...
    @include border-radius(4% 80% 0% 50%);
    position: absolute;
    left: -20px;
    top: 0px;
  ...
  .erduo > div:last-child {
    ...
    background: #f3f3f3;
    @include transform(rotate(15deg));
    @include border-radius(80% 4% 50% 0%);
    position: absolute;
    right: -20px;
    top: 0px;
  ...
  .mao:hover .erduo > div:first-child {
    ...
    @include border-radius(4% 80% 0% 60%);
  }

  .mao:hover .erduo > div:last-child {
    right: -10px;
    @include transform(rotate(0deg));
    @include border-radius(80% 4% 60% 0%);
  }
  /*眼睛*/
  .yanjing {
    height: 60px;
  ...
  .face_huawen_huawen > div:first-child {
    ...
    @include border-radius(30% 80% 20% 50%);
  ...
  .face_huawen_huawen > div:nth-child(3) {
    ...
    @include border-radius(30% 0% 90% 30%);
    @include transform(rotate(25deg));
    margin-left: 8px;
  }
  ...
  .zuiba > div:nth-child(2) {
    ...
    @include border-radius(40% 0% 20% 50%);
    margin-left: 13px;
    margin-top: -26px;
    position:absolute;
  ...
  .zuiba > div:nth-child(3) {
    ...
    @include border-radius(0% 40% 50% 20%);
    margin-left: -38px;
    margin-top: -26px;
    position:absolute;
    transition:  border-radius  1s;
