  ...
  .wrapper {
    ...
    .body {
      ...
      .eye {
        ...
        background: #006837;
        @include animation(eye 2.5s 1s linear infinite);
      }
    ...
    .foot {
      ...
      &:after{
        ...
        @include transform(rotate(102.5deg) skew(25deg));
      }
    }
    ...
    .small_leg2 {
      @include transform(rotate(60deg) scaleX(-1));
      left: 180px;
      &:after {
        content: '';
        position: absolute;
    ...
    .circle {
      ...
      @include transform(rotateX(85deg));
