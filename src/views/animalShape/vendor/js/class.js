...
class ShapeshifterSettings {
  constructor(options) {
    ...
    this.options = {}
    this.options.transformSpeed = { x: defaultSpeed, y: defaultSpeed }
    this.options.hideSpeed = { x: defaultSpeed, y: defaultSpeed }
...
class Shapeshifter extends ShapeshifterCanvas {
  ...
  applyScale() {
    if (!this.cachedInitialScale) this.cachedInitialScale = this.options.scale
